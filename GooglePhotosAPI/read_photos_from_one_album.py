...
# Hayan Album
# album_id = 'AOzt70r-8OiNKXfK4Za2OxVm90MO_qMJDoG8knNRO-gHxfL3-9lI13KRGpWGa6E9vqnQtD-KSyLZ'
album_id = "AOzt70pqJpqJ8LWeiUg8Ezgu_wpDIh2Z9kc87CTIirY8DwHyfekocCAlXdYkV3z3gElkz8VjT6S7"
while next_page_token:
    ...
    for media_item in media_files:
        if media_item["mimeType"] == 'image/jpeg':
            filename = f"AlbumPhotos/Sniggy/{media_item['filename']}"
